...
import { getMysqlTemplesTotalCount, getMysqlTemplseMonthlyCount } from 'src/redux/temples/TemplesActions';

const TemplesDashboard = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getMysqlTemplseMonthlyCount());
...
export default TemplesDashboard;
