...
import TemplesDashboard from 'src/temples/TemplesDashboard';
...
const TemplesRoutes = () => {
  const templesRoutes = useRoutes([
    {
      path: '/dashboard',
      element: <DashboardLayout />,
      children: [
        { element: <Navigate to="/dashboard/temples" />, index: true },
        { path: 'temples', element: <TemplesDashboard /> },
