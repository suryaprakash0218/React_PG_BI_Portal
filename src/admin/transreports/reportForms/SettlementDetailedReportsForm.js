...
const SettlementDetailedReportsForm = ({ report, reportType }) => {
        ...
        validationSchema={Yup.object().shape({
          ...
          endDate: Yup.date()
            ...
            .when('startDate', (startDate, schema) => {
              return startDate ? schema.required('startDate is required when endDate is filled') : schema;
            }),
        })}
              ...
              <Grid item xs={12} md={4}>
                ...
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value={'Payment Success and Department Success'}>
                      Payment Success and Department Success
                    </MenuItem>
                  </Select>
                </FormControl>
              </Grid>
...
export default SettlementDetailedReportsForm;
